...
osThreadId StartPWM_TaskHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of StartPWM_Task */
  osThreadDef(StartPWM_Task, PWM_Task, osPriorityRealtime, 0, 256);
  StartPWM_TaskHandle = osThreadCreate(osThread(StartPWM_Task), NULL);
...
/**
* @brief Function implementing the StartPWM_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_PWM_Task */
__weak void PWM_Task(void const * argument)
{
